...
def get_engine():
    if 'engine' in config.attributes:
        return config.attributes['engine']
    try:
...
def get_metadata():
    return config.attributes.get('target_metadata', target_metadata)
...
def run_migrations_online():
    """Run migrations in 'online' mode with proper Flask app context."""
